...
<div class="container">
			...
			<div class="row">
				<template v-if="role == 2">
					<div class="form-group col-xs-2 text-center">
						...
						<select name="school level" id="school_level" class="form-control">		<option value="" selected disabled>Select</option>		</select>
					</div>
					<div class="form-group col-xs-2 col-xs-offset-1 text-center">
						<label for="school_name">School Name</label>
						<select name="school name" id="school_name" class="form-control">		<option value="" selected disabled>Select</option>		</select>
					</div>
					<div class="form-group col-xs-2 col-xs-offset-1 text-center">
						<label for="mentor">Mentor</label>
						<select name="mentor" id="mentor" class="form-control">		<option value="" selected disabled>Select</option>		</select>
					</div>
				</template>
	...
	<create-modal v-if="createModal" @close="createModal = false">
		<h1 class="text-center" slot="header">Add/Edit Student</h1>
	</create-modal>
</div>
</template>
